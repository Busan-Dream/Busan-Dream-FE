...
export default function GradientText({
  ...
  return (
    <div
      className={`relative mx-auto flex max-w-fit cursor-pointer flex-row items-center justify-center overflow-hidden rounded-[1.25rem] font-bold backdrop-blur transition-shadow duration-500 ${className}`}
    >
      {showBorder && (
        <div
